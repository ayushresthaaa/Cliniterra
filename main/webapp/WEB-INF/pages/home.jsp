...
<body>
  ...
  <!-- Navbar -->
   <!-- <img class="logo" src="images/clinilogobgrem.png" alt="Logo">-->
  ...
  <!-- Second section -->
    <section class="section">
      <div class="top-bar">
        ...
        <!-- <button class="btn-dept">MORE DEPARTMENT</button> -->
      ...
      <div class="cards">
        ...
        <div class="card">
          ...
          <p>A doctor who diagnoses and treats disorders of the nervous system, including the brain, spinal cord, and nerves.
            </p>   
        </div>
